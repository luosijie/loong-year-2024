...
export default [
    ...
    { name: 'model-lantern', type: LoaderType.GLTF, path: '/models/lantern.glb'},
    { name: 'model-elements', type: LoaderType.GLTF, path: '/models/elements.glb'},

    { name: 'model-loong-head', type: LoaderType.GLTF, path: '/models/loong-head.glb'},
    { name: 'model-loong-body', type: LoaderType.GLTF, path: '/models/loong-body.glb'},
    { name: 'model-loong-foot', type: LoaderType.GLTF, path: '/models/loong-foot.glb'},
    { name: 'model-loong-tail', type: LoaderType.GLTF, path: '/models/loong-tail.glb'},
    { name: 'model-loong-path', type: LoaderType.GLTF, path: '/models/loong-path.glb'},
    ...
    { name: 'matcap-loong-brown-light', type: LoaderType.Texture, path: '/matcaps/loong-brown-light.webp'},
    { name: 'matcap-loong-brown', type: LoaderType.Texture, path: '/matcaps/loong-brown.webp'},
    { name: 'matcap-loong-pink', type: LoaderType.Texture, path: '/matcaps/loong-pink.webp'},
    { name: 'matcap-loong-red-dark', type: LoaderType.Texture, path: '/matcaps/loong-red-dark.webp'},
    { name: 'matcap-loong-red', type: LoaderType.Texture, path: '/matcaps/loong-red.webp'},
